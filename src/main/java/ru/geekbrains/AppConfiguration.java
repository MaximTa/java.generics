    ...
    public ServletContextInitializer initializer()
    {
        return new ServletContextInitializer()
        {
            ...
            public void onStartup(ServletContext servletContext) throws ServletException {
                servletContext.setInitParameter("tapestry.app-package", "ru.geekbrains");
                servletContext.setInitParameter("tapestry.development-modules", "ru.geekbrains.services.DevelopmentModule");
